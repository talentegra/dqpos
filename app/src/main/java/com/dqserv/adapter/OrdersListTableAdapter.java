...
public class OrdersListTableAdapter extends RecyclerView.Adapter<OrdersListTableAdapter.MyViewHolder> {
    ...
    public OrdersListTableAdapter(List<TableObject.Tables> tablesList,
                                  CustomItemClickListener listener) {

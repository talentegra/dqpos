...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + ORD_ITEMS_TABLE_NAME + " ( " + COLUMN_ORD_ITEM_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + COLUMN_ORD_ID + " INTEGER," + COLUMN_PROD_ID + " INTEGER," + COLUMN_PROD_CODE + " VARCHAR, " + COLUMN_PROD_NAME + " VARCHAR," + COLUMN_ITEM_QTY + " INTEGER, " + COLUMN_PROD_PRICE + " REAL," + COLUMN_SUB_TOTAL + " REAL, " + COLUMN_PROD_ID + "_" + COLUMN_TAB_ID + " TEXT UNIQUE);");
